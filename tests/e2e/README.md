...
| `desktop/auth-recovery.spec.ts` | 401/403 warnings, queued writes through reload and reauthorization, OAuth denial, stale tokens, discovery retry, offline/unreachable indicators, temporary server failure recovery, and forged OAuth callback protection |
